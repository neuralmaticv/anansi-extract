...
while True:
    ...
    if writeDebugInfoOnImages:
        cv2.line(
            ...
            (seekAreaBorderHorizontalLineXStart, seekAreaBorderHorizontalLineY),
            (seekAreaBorderHorizontalLineXEnd, seekAreaBorderHorizontalLineY),
            (74, 153, 255),
            thickness=3,
        )
        cv2.line(
            original_img_preview,
            (seekAreaBorderLeftX, seekAreaBorderHorizontalLineY),
        ...
        cv2.line(
            original_img_preview,
            (seekAreaBorderRightX, seekAreaBorderHorizontalLineY),
    ...
    for cnt in contoursInGreenMask:
        ...
        if (
            area > maxGreenArea
            and numberOfPoints >= 4
            and numberOfPoints <= 6
            and area > areaThreashold
            and areAllPointsInsideSeekBorderArea(
                approx, seekAreaBorderHorizontalLineY, seekAreaBorderLeftX, seekAreaBorderRightX
            )
        ):
            green_ymin, green_ymax, green_xmin, green_xmax = calculateMinMaxPoints(
                font, original_img_preview, original_img_previewHeight, original_img_previewWidth, approx
            )
            maxGreenArea = area
    ...
    for cnt in contoursInBlueMask:
        ...
        if (
            ...
            and numberOfPoints <= 6
            and area > areaThreashold
            and area > 3 * maxGreenArea
            and areAllPointsInsideSeekBorderArea(
                approx, seekAreaBorderHorizontalLineY, seekAreaBorderLeftX, seekAreaBorderRightX
            )
        ):
            blue_ymin, blue_ymax, blue_xmin, blue_xmax = calculateMinMaxPoints(
                font, original_img_preview, original_img_previewHeight, original_img_previewWidth, approx
            )
            maxBlueArea = area
