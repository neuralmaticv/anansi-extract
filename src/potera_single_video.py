...
parser = argparse.ArgumentParser(
    description="Potera single video processor", formatter_class=argparse.ArgumentDefaultsHelpFormatter
)
...
def areAllPointsInsideSeekBorderArea(
    contour, seekAreaBorderHorizontalY, seekAreaBorderVerticalXLeft, seekAreaBorderVerticalXRight
):
    result = True
    n = contour.ravel()
    i = 0
